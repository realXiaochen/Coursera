...
angular.module('confusionApp')
        ...
        .controller('IndexController', ['$scope', '$stateParams', 'menuFactory', 'corporateFactory',function($scope, $stateParams, menuFactory, corporateFactory) {
                ...
                $scope.message="Loading ...";
                $scope.message_1 = "Loading ...";
                $scope.message_2 = "Loading ...";
                ...
                .$promise.then(
                    ...
                    function(response) {
                        $scope.message_1 = "Error: "+response.status + " " + response.statusText;
                    }
                );
                ...
                .$promise.then(
                    ...
                    function(response) {
                        $scope.message_2 = "Error: "+response.status + " " + response.statusText;
                    }
                );                
            }])
        ...
        .controller('AboutController', ['$scope', '$stateParams', 'corporateFactory', function($scope, $stateParams, corporateFactory) {
                ...
                $scope.aboutus_showLeader = false;
                $scope.leaders = corporateFactory.getLeaders().query(
                    function(response){
                        $scope.leaders = response;
                        $scope.aboutus_showLeader = true;
                    },
                    function(response) {
